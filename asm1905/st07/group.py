...
from asm1904.st19.ProforgAction import ProforgAction
from asm1904.st19.StarostaAction import StarostaAction
from asm1904.st19.StudentAction import StudentAction
...
class Group:
    ...
    def save(self):
        f = open('./asm1905/st07/file', 'wb')
        pickle.dump(self.group, f)
        print('Список сохранен')

    def load(self):
        f = open('./asm1905/st07/file', 'rb')
